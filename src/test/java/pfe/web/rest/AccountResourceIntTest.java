package pfe.web.rest;

import pfe.config.Constants;
import pfe.GestionPfeApp;
import pfe.domain.Authority;
import pfe.domain.PersistentToken;
import pfe.domain.User;
import pfe.repository.AuthorityRepository;
import pfe.repository.PersistentTokenRepository;
import pfe.repository.UserRepository;
import pfe.security.AuthoritiesConstants;
import pfe.service.MailService;
import pfe.service.dto.UserDTO;
import pfe.web.rest.errors.ExceptionTranslator;
import pfe.web.rest.vm.KeyAndPasswordVM;
import pfe.web.rest.vm.ManagedUserVM;
import pfe.service.UserService;
...
@SpringBootTest(classes = GestionPfeApp.class)
