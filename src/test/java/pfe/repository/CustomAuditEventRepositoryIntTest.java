...
import pfe.config.audit.AuditEventConverter;
import pfe.domain.PersistentAuditEvent;
...
import static pfe.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
